...
The `variant` values sometimes contain additional info like fuel type, gearbox type (transmission), engine capacity. However, this information is already available in other columns. Hence we not perform any data cleaning in `variant` column.
